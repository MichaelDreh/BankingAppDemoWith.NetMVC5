...
(function (window, undefined) {
    var jQuery = function (selector, db) {
        /// <summary>
        ...
        /// </param>
        /// <param name="db" type="">
        ///     A DOM Element, Document, or jQuery to use as db
        /// </param>
        /// <returns type="jQuery" />

        // The jQuery object is actually just the init constructor 'enhanced'
        return new jQuery.fn.init(selector, db, rootjQuery);
    };
    ...
    jQuery.ajax = function (url, options) {
        ...
        var transport,
			...
			globalEventdb = s.db && (callbackdb.nodeType || callbackdb.jquery) ?
				jQuery(callbackdb) :
				jQuery.event,
			// Deferreds
        ...
        if (s.beforeSend && (s.beforeSend.call(callbackdb, jqXHR, s) === false || state === 2)) {
    ...
    jQuery.buildFragment = function (elems, db, scripts, selection) {
    ...
    jQuery.contains = function (db, elem) {
        /// <summary>
        ///     Check to see if a DOM element is a descendant of another DOM element.
        /// </summary>
        /// <param name="db" domElement="true">
    ...
    jQuery.find = function Sizzle(selector, db, results, seed) {

        var match, elem, m, nodeType,
            // QSA vars
            i, groups, old, nid, newdb, newSelector;
        ...
        if ((nodeType = db.nodeType) !== 1 && nodeType !== 9) {
            return [];
        }
        ...
        if (documentIsHTML && !seed) {
            ...
            if ((match = rquickExpr.exec(selector))) {
                ...
                if ((m = match[1])) {
                    if (nodeType === 9) {
                        ...
                        // db is not a document
                        if (db.ownerDocument && (elem = db.ownerDocument.getElementById(m)) &&
                            contains(db, elem) && elem.id === m) {
                            results.push(elem);
                            return results;
                        }
                    }
                ...
                } else if ((m = match[3]) && support.getElementsByClassName && db.getElementsByClassName) {
            ...
            if (support.qsa && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
                ...
                if (nodeType === 1 && db.nodeName.toLowerCase() !== "object") {
                    groups = tokenize(selector);

                    if ((old = db.getAttribute("id"))) {
                        nid = old.replace(rescape, "\\$&");
                    } else {
                        db.setAttribute("id", nid);
                    }
                    nid = "[id='" + nid + "'] ";
                    ...
                    newdb = rsibling.test(selector) && db.parentNode || db;
    ...
    jQuery.parseHTML = function (data, db, keepScripts) {
        ...
        /// </param>
        /// <param name="db" domElement="true">
        ///     DOM element to serve as the db in which the HTML fragment will be created
        /// </param>
        ...
        parsed = jQuery.buildFragment([data], db, scripts);
    ...
    jQuery.proxy = function (fn, db) {
        /// <summary>
        ///     Takes a function and returns a new one that will always have a particular db.
        ///     &#10;1 - jQuery.proxy(function, db) 
        ///     &#10;2 - jQuery.proxy(db, name) 
        ///     &#10;3 - jQuery.proxy(function, db, additionalArguments) 
        ///     &#10;4 - jQuery.proxy(db, name, additionalArguments)
        /// </summary>
        /// <param name="fn" type="Function">
        ///     The function whose db will be changed.
        /// </param>
        /// <param name="db" type="PlainObject">
        ///     The object to which the db (this) of the function should be set.
        /// </param>
        ...
        proxy = function () {
            return fn.apply(db || this, args.concat(core_slice.call(arguments)));
        };
    ...
    jQuery.prototype.add = function (selector, db) {
        /// <summary>
        ...
        /// </param>
        /// <param name="db" domElement="true">
        ///     The point in the document at which the selector should begin matching; similar to the db argument of the $(selector, db) method.
        /// </param>
        /// <returns type="jQuery" />
    ...
    jQuery.prototype.closest = function (selectors, db) {
        /// <summary>
        ...
        ///     &#10;    2.1 - closest(selectors, db)
        /// </summary>
        /// <param name="selectors" type="String">
        ///     A string containing a selector expression to match elements against.
        /// </param>
        /// <param name="db" domElement="true">
        ///     A DOM element within which a matching element may be found. If no db is passed in then the db of the jQuery set will be used instead.
        /// </param>
        /// <returns type="jQuery" />
    ...
    jQuery.prototype.constructor = function (selector, db) {
    ...
    jQuery.prototype.dbmenu = function (data, fn) {
    ...
    jQuery.prototype.init = function (selector, db, rootjQuery) {
        ...
        if (typeof selector === "string") {
            ...
            if (match && (match[1] || !db)) {
                ...
                return (db || rootjQuery).find(selector);
    ...
    jQuery.prototype.is = function (selector) {
        ...
        return !!selector && (
			typeof selector === "string" ?
				...
				rneedsdb.test(selector) ?
					jQuery(selector, this.db).index(this[0]) >= 0 :
    ...
    jQuery.prototype.replaceWith = function () {
        ...
        // Make the changes, replacing each db element with the new content
        this.domManip(arguments, function (elem) {
            ...
            // Allow new content to include elements from the db set
        }, true);
