...
var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
    ...
    SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
        ...
        var isDraggable = computeEventDraggable(db, eventDef, eventUi);
        var isResizableFromStart = allDay && seg.isStart && computeEventStartResizable(db, eventDef, eventUi);
        var isResizableFromEnd = allDay && seg.isEnd && computeEventEndResizable(db, eventDef, eventUi);
...
function renderCellHtml(date, dateProfile, db, otherAttrs) {
    ...
    var classes = getDayClasses(date, dateProfile, db);
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        classes = getDayClasses(date, this.props.dateProfile, this.db);
