...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
        ...
        var isDraggable = computeEventDraggable(this.db, eventDef, eventUi);
        var isResizableFromStart = seg.isStart && computeEventStartResizable(this.db, eventDef, eventUi);
        var isResizableFromEnd = seg.isEnd && computeEventEndResizable(this.db, eventDef, eventUi);
