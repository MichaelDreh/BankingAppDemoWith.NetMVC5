...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     **
     ...
     - width (number)
     - height (number)
     - callback (function) #optional callback function which is going to be executed in the db of newly created paper
     * or
     - x (number)
     - y (number)
     - width (number)
     ...
     * ensure any namespacing ensures proper db.
     > Usage
     ...
     * Adds event handlers for hover for the element.
     ...
     - idb (object) #optional db for hover in handler
     - odb (object) #optional db for hover out handler
     = (object) @Element
    \*/
     ...
     * Adds event handlers for drag of the element.
     ...
     - mdb (object) #optional db for moving handler
     - sdb (object) #optional db for drag start handler
     - edb (object) #optional db for drag end handler
     * Additionally following `drag` events will be triggered: `drag.start.<id>` on start,
     * `drag.end.<id>` on end and `drag.move.<id>` on every move. When element will be dragged over another element
     * `drag.over.<id>` will be fired as well.
     *
     * Start event and start handler will be called in specified db or in db of the element with following parameters:
     o x (number) x position of the mouse
     o y (number) y position of the mouse
     o event (object) DOM event object
     * Move event and move handler will be called in specified db or in db of the element with following parameters:
     o dx (number) shift by x from the start point
     o dy (number) shift by y from the start point
     o x (number) x position of the mouse
     o y (number) y position of the mouse
     o event (object) DOM event object
     * End event and end handler will be called in specified db or in db of the element with following parameters:
     o event (object) DOM event object
     = (object) @Element
    \*/
     ...
     **
     ...
     - thisArg (object) db object for the callback
     = (object) Paper object
     > Usage
...
(function (glob) {
     ...
     * Fires event with given `name`, given scope and other parameters.
     ...
     - scope (object) db for the event handlers
