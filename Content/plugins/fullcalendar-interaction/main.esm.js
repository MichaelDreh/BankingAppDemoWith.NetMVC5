...
var DateSelecting = /** @class */ (function (_super) {
    ...
    function DateSelecting(settings) {
        ...
        _this.handlePointerDown = function (ev) {
            ...
            var options = component.db.options;
        ...
        _this.handleDragStart = function (ev) {
            _this.component.db.calendar.unselect(ev); // unselect previous selections
        };
        _this.handleHitUpdate = function (hit, isFinal) {
            var calendar = _this.component.db.calendar;
        ...
        _this.handlePointerUp = function (pev) {
            if (_this.dragSelection) {
                ...
                _this.component.db.calendar.triggerDateSelect(_this.dragSelection, pev);
                _this.dragSelection = null;
            }
        };
        var component = settings.component;
...
var EventDragging = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
        ...
        _this.handlePointerDown = function (ev) {
            ...
            var options = component.db.options;
            var initialCalendar = component.db.calendar;
        ...
        _this.handleDragStart = function (ev) {
            var db = _this.component.db;
            var initialCalendar = db.calendar;
        ...
        _this.handleHitUpdate = function (hit, isFinal) {
            ...
            var initialCalendar = _this.component.db.calendar;
            ...
            if (hit) {
                ...
                receivingCalendar = receivingComponent.db.calendar;
                var receivingOptions = receivingComponent.db.options;
        ...
        _this.handleDragEnd = function (ev) {
            if (_this.isDragging) {
                var db = _this.component.db;
                var initialCalendar_1 = db.calendar;
                var initialView = db.view;
    ...
    EventDragging.prototype.displayDrag = function (nextCalendar, state) {
        var initialCalendar = this.component.db.calendar;
...
function computeEventMutation(hit0, hit1, massagers) {
    ...
    if (dateSpan0.allDay !== dateSpan1.allDay) {
        ...
        standardProps.hasEnd = hit1.component.db.options.allDayMaintainDuration;
        if (dateSpan1.allDay) {
    ...
    var delta = diffDates(date0, date1, hit0.component.db.dateEnv, hit0.component === hit1.component ?
...
var EventDragging$1 = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
        ...
        _this.handlePointerDown = function (ev) {
            ...
            _this.dragging.minDistance = component.db.options.eventDragMinDistance;
            // if touch, need to be working with a selected event
            _this.dragging.setIgnoreMove(!_this.component.isValidSegDownEl(ev.origEvent.target) ||
                (ev.isTouch && _this.component.props.eventSelection !== eventRange.instance.instanceId));
        };
        _this.handleDragStart = function (ev) {
            var _a = _this.component.db, calendar = _a.calendar, view = _a.view;
            var eventRange = _this.eventRange;
        ...
        dragging.touchScrollAllowed = false;
        dragging.autoScroller.isEnabled = component.db.options.dragScroll;
        var hitDragging = _this.hitDragging = new HitDragging(_this.dragging, interactionSettingsToStore(settings));
        hitDragging.emitter.on('pointerdown', _this.handlePointerDown);
        hitDragging.emitter.on('dragstart', _this.handleDragStart);
        hitDragging.emitter.on('hitupdate', _this.handleHitUpdate);
...
function computeMutation(hit0, hit1, isFromStart, instanceRange, transforms) {
    var dateEnv = hit0.component.db.dateEnv;
...
var ExternalElementDragging = /** @class */ (function () {
    function ExternalElementDragging(dragging, suppliedDragMeta) {
        ...
        this.handleHitUpdate = function (hit, isFinal, ev) {
            ...
            if (hit) {
                receivingCalendar = hit.component.db.calendar;
        ...
        this.handleDragEnd = function (pev) {
            ...
            if (receivingCalendar && droppableEvent) {
                var finalHit = _this.hitDragging.finalHit;
                var finalView = finalHit.component.db.view;
