...
declare module '@fullcalendar/daygrid/SimpleDayGrid' {
    import { DateProfile, EventStore, EventUiHash, DateSpan, EventInteractionState, DayTable, Duration, DateComponent, DateRange, Slicer, Hit, Componentdb } from '@fullcalendar/core';
    ...
    class SimpleDayGrid extends DateComponent<SimpleDayGridProps> {
        ...
        destroy(): void;
        render(props: SimpleDayGridProps, db: Componentdb): void;
...
declare module '@fullcalendar/daygrid/DayGrid' {
    import { PositionCache, DateMarker, DateComponent, EventSegUiInteractionState, Seg, DateProfile, Componentdb } from '@fullcalendar/core';
    ...
    class DayGrid extends DateComponent<DayGridProps> {
        ...
        render(props: DayGridProps, db: Componentdb): void;
        destroy(): void;
...
declare module '@fullcalendar/daygrid/AbstractDayGridView' {
    import { ScrollComponent, View, Duration, Componentdb, ViewProps } from '@fullcalendar/core';
...
declare module '@fullcalendar/daygrid/DayGridView' {
    import { DayHeader, Componentdb, DateProfileGenerator, DateProfile, ViewProps, DayTable } from '@fullcalendar/core';
...
declare module '@fullcalendar/daygrid/DayBgRow' {
    import { Componentdb, DateMarker, DateProfile } from '@fullcalendar/core';
...
declare module '@fullcalendar/daygrid/DayTile' {
    import { DateComponent, Seg, Hit, DateMarker, Componentdb, EventInstanceHash } from '@fullcalendar/core';
    import SimpleDayGridEventRenderer from '@fullcalendar/daygrid/SimpleDayGridEventRenderer';
    ...
    class DayTile extends DateComponent<DayTileProps> {
        ...
        firstdb(db: Componentdb): void;
        render(props: DayTileProps, db: Componentdb): void;
        destroy(): void;
