...
declare module '@fullcalendar/core' {
    ...
    export { default as Component, Componentdb } from '@fullcalendar/core/component/Component';
...
declare module '@fullcalendar/core/util/misc' {
    ...
    export function preventdbMenu(el: HTMLElement): void;
    export function allowdbMenu(el: HTMLElement): void;
...
declare module '@fullcalendar/core/component/date-rendering' {
    import { DateMarker } from '@fullcalendar/core/datelib/marker';
    import { Componentdb } from '@fullcalendar/core/component/Component';
    ...
    export function getDayClasses(date: DateMarker, dateProfile: DateProfile, db: Componentdb, noThemeHighlight?: any): any[];
}
...
declare module '@fullcalendar/core/common/EmitterMixin' {
    ...
    export interface EmitterInterface {
        ...
        triggerWith(type: any, db: any, args: any): any;
    ...
    class EmitterMixin extends Mixin implements EmitterInterface {
        ...
        triggerWith(type: any, db: any, args: any): this;
        hasHandlers(type: any): any;
    }
}
...
declare module '@fullcalendar/core/component/Component' {
    ...
    export class Componentdb {
        ...
        extend(options?: any, view?: View): Componentdb;
    }
    ...
    class Component<PropsType> {
        ...
        receiveProps(props: PropsType, db: Componentdb): void;
        protected render(props: PropsType, db: Componentdb): void;
        firstdb(db: Componentdb): void;
        beforeUpdate(): void;
        afterUpdate(): void;
        destroy(): void;
    }
...
declare module '@fullcalendar/core/View' {
    ...
    abstract class View extends DateComponent<ViewProps> {
        ...
        render(props: ViewProps, db: Componentdb): void;
        beforeUpdate(): void;
        destroy(): void;
...
declare module '@fullcalendar/core/component/renderers/FgEventRenderer' {
    ...
    abstract class FgEventRenderer {
        ...
        segs: Seg[];
        isSizeDirty: boolean;
        renderSegs(db: Componentdb, segs: Seg[], mirrorInfo?: any): void;
        unrender(db: Componentdb, _segs: Seg[], mirrorInfo?: any): void;
...
declare module '@fullcalendar/core/component/renderers/FillRenderer' {
    ...
    abstract class FillRenderer {
        ...
        renderSegs(type: string, db: Componentdb, segs: Seg[]): void;
        unrender(type: string, db: Componentdb): void;
...
declare module '@fullcalendar/core/datelib/formatting' {
    ...
    export interface DateFormattingdb {
        timeZone: string;
        locale: Locale;
        calendarSystem: CalendarSystem;
    ...
    export interface DateFormatter {
        format(date: ZonedMarker, db: DateFormattingdb): any;
        formatRange(start: ZonedMarker, end: ZonedMarker, db: DateFormattingdb): any;
    }
    ...
    export function createVerboseFormattingArg(start: ZonedMarker, end: ZonedMarker, db: DateFormattingdb, separator?: string): VerboseFormattingArg;
}
...
declare module '@fullcalendar/core/CalendarComponent' {
    import Component, { Componentdb } from '@fullcalendar/core/component/Component';
    import { ViewSpec } from '@fullcalendar/core/structs/view-spec';
    import View from '@fullcalendar/core/View';
    ...
    class CalendarComponent extends Component<CalendarComponentProps> {
        ...
        viewHeight: number;
        constructor(el: HTMLElement);
        render(props: CalendarComponentProps, db: Componentdb): void;
        destroy(): void;
        _renderSkeleton(db: Componentdb): void;
        _unrenderSkeleton(): void;
        removeElClassNames(): void;
        updateElClassNames(db: Componentdb): void;
...
declare module '@fullcalendar/core/common/DayHeader' {
    ...
    class DayHeader extends Component<DayTableHeaderProps> {
        ...
        render(props: DayTableHeaderProps, db: Componentdb): void;
        destroy(): void;
        _renderSkeleton(db: Componentdb): void;
        _unrenderSkeleton(): void;
    }
...
declare module '@fullcalendar/core/common/table-utils' {
    ...
    export function renderDateCell(dateMarker: DateMarker, dateProfile: DateProfile, datesRepDistinctDays: any, colCnt: any, colHeadFormat: any, db: Componentdb, colspan?: any, otherAttrs?: any): string;
}
...
declare module '@fullcalendar/core/component/event-rendering' {
    ...
    export function filterSegsViaEls(db: Componentdb, segs: Seg[], isMirror: boolean): Seg[];
    ...
    export function triggerRenderedSegs(db: Componentdb, segs: Seg[], isMirrors: boolean): void;
    export function triggerWillRemoveSegs(db: Componentdb, segs: Seg[], isMirrors: boolean): void;
    export function computeEventDraggable(db: Componentdb, eventDef: EventDef, eventUi: EventUi): boolean;
    export function computeEventStartResizable(db: Componentdb, eventDef: EventDef, eventUi: EventUi): any;
    export function computeEventEndResizable(db: Componentdb, eventDef: EventDef, eventUi: EventUi): boolean;
}
...
declare module '@fullcalendar/core/datelib/formatting-cmd' {
    import { DateFormatter, DateFormattingdb, ZonedMarker, VerboseFormattingArg } from '@fullcalendar/core/datelib/formatting';
    ...
    export class CmdFormatter implements DateFormatter {
        ...
        format(date: ZonedMarker, db: DateFormattingdb): string;
        formatRange(start: ZonedMarker, end: ZonedMarker, db: DateFormattingdb): string;
    }
}
