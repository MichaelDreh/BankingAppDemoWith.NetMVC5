...
declare module '@fullcalendar/timegrid/AbstractTimeGridView' {
    import { ScrollComponent, View, Componentdb, Duration, ViewProps } from '@fullcalendar/core';
...
declare module '@fullcalendar/timegrid/TimeGridView' {
    import { DateProfileGenerator, DateProfile, Componentdb, DayHeader, DayTable, ViewProps } from '@fullcalendar/core';
...
declare module '@fullcalendar/timegrid/TimeGrid' {
    import { PositionCache, Duration, DateMarker, DateFormatter, Componentdb, DateComponent, Seg, EventSegUiInteractionState, DateProfile, Theme } from '@fullcalendar/core';
    ...
    class TimeGrid extends DateComponent<TimeGridProps> {
        ...
        render(props: TimeGridProps, db: Componentdb): void;
        destroy(): void;
...
declare module '@fullcalendar/timegrid/SimpleTimeGrid' {
    import { DateComponent, DateProfile, EventStore, EventUiHash, EventInteractionState, DateSpan, DateRange, DayTable, DateEnv, DateMarker, Slicer, Hit, Componentdb } from '@fullcalendar/core';
    ...
    class SimpleTimeGrid extends DateComponent<SimpleTimeGridProps> {
        ...
        destroy(): void;
        render(props: SimpleTimeGridProps, db: Componentdb): void;
